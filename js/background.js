var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ferrari-f50-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ferrari-f50-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ferrari-f50-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ferrari-f50-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ferrari F50?",
				description: "Get awesome Ferrari F50 HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
